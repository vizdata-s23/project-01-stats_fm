...
ggplot(station_temp, aes(x = pop_2022, y = n, color = region_name)) +
  geom_smooth(method = "lm", se = FALSE, size = 0.75, linetype = "longdash") +
  geom_point(alpha = 0.6) +
  geom_text_repel(data=subset(station_temp, pop_2022 > 15000000 | n > 500), aes(label = state), color = "black", size = 3) +
